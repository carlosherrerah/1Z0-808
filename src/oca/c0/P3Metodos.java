...
public class P3Metodos {
  ...
  public static int pnn(int x) {   // funcion    otro nombre a la funcion  porque la firma es la misma
    if (x > 0) {
      return 1;
    } else if (x < 0) {
      return -1;
  ...
  public static void main(String[] args) {
    ...
    System.out.println(getRandomNumberInRange(55, 50));
