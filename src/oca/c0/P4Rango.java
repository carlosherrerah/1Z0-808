...
public class P4Rango {
  ...
  public static void main(String[] args) {
    ...
    byte a =  127;
    Byte A =  -128;  // Byte es una clase envolvente (wrapper class) de byte
    
    //a = 128;        // Error: byte
    a = (byte) 514;   // Number is "chopped"   No error
    // 0 1 2 3 .. 127  128  129  130 .. 254  255  256  257  258  259 .. 383  384  385 .. 510 511 512 513 514
    // 0 1 2 3 .. 127 -128 -127 -126 ..  -2   -1    0    1    2    3 .. 127 -128 -127 ..  -2  -1   0   1   2
