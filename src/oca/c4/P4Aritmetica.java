...
public class P4Aritmetica {
  ...
  public static void main(String[] args) {
    ...
    // operaciones con % modulo con decimales y negativos (OCP)
    ...
    // double cociente = (int) (dividendo / divisor);
    // double resto = cociente * divisor;
    // double resultado = dividendo - resto;
